		...
		init : function(){
			...
			$('#start').on('click',function(){
				...
				$.alert('请认真填写您的调查问卷信息，填写有误将导致您的审核失败！',function(){
					...
					localStorage.survey = '{"actionTime":'+survey.appActionList[0].actionTime+',"firstStartTime":'+
										survey.questionActionRecord[0].start+'}';
				});
